...
public class SpaceMarine implements CollectionPart {
    ...
    public String toString() {
        return String.format("id: %d%n" +
                ...
                "Chapter:%n" +
                "   name: %s%n" +
                "   marinesCount: %d%n", this.id, this.name, this.coordinates.getX(), this.coordinates.getY(), this.creationDate, this.health, this.heartCount, this.category, this.meleeWeapon, this.chapter.getName(), this.chapter.getMarinesCount());
    }
}
